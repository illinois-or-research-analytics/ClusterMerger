...
```
- Input edgelist is a two column csv with source and target integer node ids on each row and a header line. The actual column values of the header row do not matter. Assumed to be unweighted and undirected without self-loops or parallel edges.
